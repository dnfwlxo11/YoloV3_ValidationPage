...
def draw_boxes(detections, image, colors):
	...
	tmp = label + ' ' + left + ' ' + top + ' ' + right + ' ' + bottom
	sys.stdout = open('/home/daein/label_server/test.txt', 'wt', encoding='utf-8')
	f.write(tmp)
	f.close()

	sys.stdout = open('/home/daein/label_server/info.txt', 'wt', encoding='utf-8')
	f.write(detections)
	f.write(image)
	f.write(colors)
	f.close()
